...
export class Student1679422638582 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE type_document_enum  AS ENUM ('cc','ce','nip','nit','ti','pap');`);
        await queryRunner.query(`CREATE TYPE education_level_enum AS ENUM ('initial', 'preschool', 'primary_basic', 'basic_high_school', 'technical_medium', 'professional_technique', 'technological', 'higher_university', 'specialization', 'mastery', 'phd', 'postdoc');`);
