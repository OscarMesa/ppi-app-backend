...
export class AdvisoryStudentsPpi1679441410254 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."advisory_students_ppi" (
          ...
          ;`);
        await queryRunner.query(`COMMENT ON COLUMN "public"."advisory_students_ppi"."individual_assistance" IS 'This json will store the pertinent information regarding the attendance of each student';`);
    }
